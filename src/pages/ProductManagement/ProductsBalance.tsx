...
import { ProductsBalanceReportModal } from "./ProductsBalanceReportModal";
...
const ProductsBalance: React.FC<ProductsBalanceViewProps> = ({ onNavigate, title, reportTitle }) => {
