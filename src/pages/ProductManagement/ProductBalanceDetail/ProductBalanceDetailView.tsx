...
import type { ProductItem, } from "../components/ProductCreateModal";
...
interface ProductBalanceDetailViewProps {
...
const ProductBalanceDetailView: React.FC<ProductBalanceDetailViewProps> = ({ onNavigate, documentId, title: propTitle,  backView = "products-balance", documentData}) => {
  ...
  const title = documentData 
    ? `№ ${documentData.number} Maxsulotlar qoldig'i hujjatini o'zgartirish`
    : propTitle || "Maxsulotlar qoldig'i yaratish";
    ...
    <>
      <div className="flex flex-col h-full overflow-hidden bg-gray-50">
        ...
        <div className="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 ml-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-gray-50 border border-gray-300 text-[10px] font-medium text-gray-700 rounded-lg transition-all"
                >
          ...
          {isHeaderExpanded && (
            <div className="grid grid-cols-6 gap-3 pb-3 border-t border-gray-100 pt-3">
              {/* Hujjat raqami */}
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full py-1.5 text-[11px] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pl-[8px] pr-[9px] py-[6px]"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-2 py-1.5 text-[11px] border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                  >
                    <option value="">Tanlang</option>
                    {selectedRegion &&
...
export default ProductBalanceDetailView;