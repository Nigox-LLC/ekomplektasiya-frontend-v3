...
const StatCard = ({
  ...
  <div
    className={`flex flex-col p-4 rounded-xl border ${borderColorClass} ${bgColorClass} flex-1 shadow-sm`}
  >
    ...
    <div className="w-full flex flex-col items-center justify-center bg-gray-50/50">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <h3 className="text-lg font-bold mb-8 text-gray-800">
              Oylik statistika
            </h3>
