  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="p-6 border-b border-gray-200">
        {/* Birinchi qator - Barcha filtrlar gorizontal */}
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Bosh qoldiq soni</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Bosh qoldiq summa</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Kirim soni</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Kirim summa</th>
              </tr>
            </thead>
            <tbody>
              {/* Bo'sh holat */}
                ...
                <td colSpan={13} className="px-4 py-16 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-600 text-sm font-medium mb-1">
                      Mahsulot aylanma hisobotini shaklantirish uchun
                    </p>
