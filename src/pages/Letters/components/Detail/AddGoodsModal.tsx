...
export function AddGoodsModal({ isOpen, onClose, onSave }: AddGoodsModalProps) {
  ...
  // Qidiruv filtri
  const filteredGoods = availableGoods.filter(
    (item) =>
                  ...
                  {selectedGoods ? (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        {selectedGoods.type} - {selectedGoods.model}
                      </span>
                    </div>
                  ) : (
                    <span className="text-gray-500">
                      Rekvizitlarni tanlash uchun bosing
                    </span>
                  )}
                </Button>
              </div>
                    ...
                    {filteredGoods.length === 0 ? (
                      ...
                      filteredGoods.map((item) => (
                        ...
                        >
                          ...
                          <td className="border border-gray-300 px-4 py-3 text-sm text-gray-600 italic">
                            {item.note}
                          </td>
                        </tr>
                      ))
