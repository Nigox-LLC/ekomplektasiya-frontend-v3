...
const mockEmployees: Employee[] = [
  ...
  },
  {
    ...
    position: "Yurist",
    department: "Yuridik bo'limi",
  },
  {
    id: "7",
    name: "Ismailov Javohir",
  ...
  {
    id: "9",
    name: "Tursunov Behzod",
    position: "Muhandis",
    department: "Texnik bo'lim",
  },
  {
    id: "10",
    name: "Sharipova Nodira",
    position: "Kotiba",
    department: "Umumiy bo'lim",
  },
  {
    id: "11",
    name: "Azimov Rustam",
...
export function SendDocumentModal({
  ...
  const handleSend = () => {
    if (selectedEmployee && selectedPurpose) {
      ...
      onSuccess(
        `Hujjat ${employeeName} ga ${purposeText.toLowerCase()} yuborildi`,
      );
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <p className="text-sm text-blue-700">
                ...
                <span className="font-medium">
                  {getPurposeText(selectedPurpose).toLowerCase()}
                </span>{" "}
                yuboriladi
              </p>
