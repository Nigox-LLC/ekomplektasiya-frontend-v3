...
const SidebarHeader: React.FC<SidebarHeaderProps> = React.memo(({ isCollapsed }) => {
    ...
    <div className="p-6 border-b border-gray-700 relative">
      <div className={`flex items-center gap-3 mb-2 ${isCollapsed ? "justify-center" : ""}`}>
        ...
        <div className={`transition-all duration-300 overflow-hidden ${
          ...
          <h1 className="text-lg font-semibold text-white whitespace-nowrap">Ekomplektasiya</h1>
          <p className="text-xs text-gray-400 whitespace-nowrap">Hujjat ijrosi tizimi</p>
        </div>
      </div>
      <button
